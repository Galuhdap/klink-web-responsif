...
import 'package:klinik_web_responsif/core/config/printer/widget/menu_printer_button.dart';
import 'package:klinik_web_responsif/core/config/printer/widget/menu_printer_content.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Container(
            width: AppSizes.setResponsiveWidth(context) / 2,
  ...
  Widget build(BuildContext context) {
    if (datas.isEmpty) {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white,
          border: Border.all(color: AppColors.colorBaseWarning, width: 2),
