...
class DatumReportPurchase {
  ...
  factory DatumReportPurchase.fromJson(Map<String, dynamic> json) =>
      DatumReportPurchase(
        ...
        total: json["total"],
        detail:
            List<DetailReportBuy>.from(json["detail"].map((x) => DetailReportBuy.fromJson(x))),
      );
...
class DetailReportBuy {
  ...
  factory DetailReportBuy.fromJson(Map<String, dynamic> json) => DetailReportBuy(
        no: json["no"],
