...
PostTransactionRequest postTransactionRequestFromJson(String str) =>
    PostTransactionRequest.fromJson(json.decode(str));

String postTransactionRequestToJson(PostTransactionRequest data) =>
