    ...
    return GetBuilder<ApotikController>(
      ...
      builder: (controller) {
        return Scaffold(
            ...
            body: Obx(() {
              return controller.isTransactionView.value
                  ? CompleteTransactionScreen(controller: controller)
                  : ListView(children: [
                                  ...
                                  children: [
                                    CustomTabelComponent(
                                              ...
                                              child: SearchNewComponent(
                                                ...
                                                onChanged: (value) {
                                                  ...
                                                  controllerHome
                                                      .noQueueController
                                                      .text = nomerAntrian;
                                                  controllerHome.noRmeController
                                                      .text = noRme;
                                      ...
                                      listRows: getRowsQueue(
                                        ...
                                        isLoading:
                                            controllerHome.isLoading.value,
