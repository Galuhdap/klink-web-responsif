...
class InputUnitMedicineComponent extends StatelessWidget {
  const InputUnitMedicineComponent({
    super.key,
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Text(
                        id.isNotEmpty ? 'Edit Satuan Obat' : 'Tambah Satuan',
                                        ...
                                        () {
                                          return controller
                                              ...
                                              : ShowModalTandaTanyaComponent(
                                                  label:
                                                      'Apakah Anda Yakin Untuk Mengubah Data Satuan Obat ?',
                                                  onTapNo: () {
                                                    Get.back();
                                                  },
                                                  onTapYes: () async {
