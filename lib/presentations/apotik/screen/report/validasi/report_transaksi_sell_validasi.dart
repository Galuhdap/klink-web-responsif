...
import 'package:klinik_web_responsif/presentations/apotik/screen/report/pdf_preview/pdf_priview_report_sell.dart';
      ...
      child: ListView(
        children: [
          CustomTabelComponent(
            ...
            customContentPagination: controller.numberOfPageReportSale.value ==
                    0
                ? Container()
                : Container(
                        ...
                        Container(
                          ...
                          child: Obx(() {
                            return NumberPaginator(
                              numberPages:
                                  controller.numberOfPageReportSale.value,
                              onPageChange: (int index) {
                                final page = index + 1;
                                final dateFormat = DateFormat('yyyy-MM-dd');
                                controller.getSaleReportMedicine(
                                  page: page,
                                  invoice: controller.noInvSearch.value,
                                  no_rekam_medis: controller.noRmeSearch.value,
                                  name: controller.namePasienSearch.value,
                                  start_date:
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    AppSizes.s100.width,
                    Obx(() => Text(
                          controller.totalSaleReport.value.currencyFormatRp,
                          style: Get.textTheme.labelMedium!.copyWith(
                            fontSize: AppSizes.s16,
                            fontWeight: FontWeight.bold,
                            color: AppColors.colorBaseBlack,
                    ...
                    child: SearchNewComponent(
                        ...
                        onChanged: (value) {
                          ...
                          for (var part in parts) {
                            if (RegExp(r'^INV-\d+$').hasMatch(part)) {
                              no_inv = part;
                          ...
                          controller.namePasienSearch.value = name;
                          controller.noInvSearch.value = no_inv;
                          controller.noRmeSearch.value = no_rme;

                          final dateFormat = DateFormat('yyyy-MM-dd');

                          controller.getSaleReportMedicine(
                            name: name,
                            no_rekam_medis: no_rme,
                            invoice: no_inv,
            ...
            listColumns: getListMedicineReportSaleColumns(),
            listRows: getRowsMedicineReportSale(
                data: controller.reportSaleMedicineList,
                isLoading: controller.isLoadingReportSale.value,
