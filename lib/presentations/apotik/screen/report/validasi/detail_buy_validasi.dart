...
import 'package:klinik_web_responsif/presentations/apotik/screen/report/pdf_preview/pdf_priview_report_detail_buy.dart';
        ...
        children: [
          CustomTabelComponent(
            arrowBack: IconButton(
              onPressed: () {
                controller.grandTotalDetailPurchaseReport.value = 0;
                controller.noBuyDetailPurchaseReport.value = '';
                controller.dateBuyDetailPurchaseReport.value = '';
                controller.supplierBuyDetailPurchaseReport.value = '';
                controller.petugasBuyDetailPurchaseReport.value = '';
            ...
            customContentButton: ButtonPrintComponent(
              ...
              onTap: () {
                Get.to(PdfPriviewReportDetailBuy());
              },
            ),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    AppSizes.s100.width,
                    Obx(() => Text(
                          controller.grandTotalDetailPurchaseReport.value
                              .currencyFormatRp,
                          style: Get.textTheme.labelMedium!.copyWith(
                            fontSize: AppSizes.s16,
                            fontWeight: FontWeight.bold,
            ...
            listColumns: getListDetailMedicineReportBuyColumns(),
            listRows: getRowsDetailMedicineReportBuy(
              controller: controller,
              data: controller.reportPurchaseMedicineList,
              isLoading: controller.isLoadingHasExpiredMedicine.value,
              selectedPurchaseNo: controller.noPurchaseReport.value,
            ),
          ),
        ],
      ),
