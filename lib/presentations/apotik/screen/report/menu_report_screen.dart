                                        ...
                                        child: ListView(
                                          children: [
                                            CustomTabelComponent(
                                              ...
                                              sizeRowTabel: MediaQuery.of(context)
                                                      .size
                                                      .width /
                                                  1.1,
                                                      ...
                                                      child: SearchNewComponent(
                                                          ...
                                                          onChanged: (value) {
                                                            ...
                                                            controller
                                                                .namePasienSearch
                                                                .value = name;
                                                            controller.noInvSearch
                                                                .value = no_inv;
                                                            controller.noRmeSearch
                                                                .value = no_rme;
                                              ...
                                              children: [
                                                CustomTabelComponent(
                                                  ...
                                                  customContentPagination:
                                                      controller.numberOfPageReportInOut
                                                                  .value ==
                                                              0
                                                          ? Container()
                                                          : Container(
                                                  ...
                                                  listColumns:
                                                      getListMedicineReportInOutColumns(),
                                                  listRows: getRowsMedicineReportInOut(
                                                      data: controller
                                                          .reportInOutMedicineList,
                                                      isLoading: controller
                                                          .isLoadingReportInOut
                                                          .value,
                                                      controller: controller),
                                                ),
                                              ],
