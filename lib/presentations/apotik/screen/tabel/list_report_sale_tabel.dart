...
List<DataColumn> getListMedicineReportSaleColumns() {
  return [
    DataColumn(
      label: Text(
        'NO',
...
List<DataRow> getRowsMedicineReportSale({
  required ApotikController controller,
  required List<DatumReportSale> data, // ganti dengan model aslimu
    ...
    return DataRow(
      ...
      cells: [
        ...
        DataCell(Text(row.invoice,
            style: const TextStyle(fontWeight: FontWeight.bold))),
        DataCell(Text(row.noRekamMedis,
            style: const TextStyle(fontWeight: FontWeight.bold))),
        DataCell(Text(row.namaPasien,
            style: const TextStyle(fontWeight: FontWeight.bold))),
        DataCell(Text(row.tanggalTransaksi.toDateddmmmyyyyFormattedString(),
            style: const TextStyle(fontWeight: FontWeight.bold))),
        DataCell(Text(row.petugasApotik,
            style: const TextStyle(fontWeight: FontWeight.bold))),
        DataCell(Text(row.nominal.currencyFormatRp,
            style: const TextStyle(fontWeight: FontWeight.bold))),
        DataCell(
          Center(
            child: InkWell(
