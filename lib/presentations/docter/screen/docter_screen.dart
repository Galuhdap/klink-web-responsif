        ...
        return Scaffold(
          ...
          body: ListView(
            children: [
                                                                                            ...
                                                                                            showModalCenter(
                                                                                              ...
                                                                                              Column(
                                                                                                ...
                                                                                                children: [
                                                                                                  ...
                                                                                                  InputDataComponent(
                                                                                                    label: 'Tanggal Lahir',
                                                                                                    hintText: doctor.tglLahir.toDateyyyymmddFormattedString(),
                                                                                                    controller: TextEditingController(),
                                                                                                    readOnly: true,
                                                                                                  ),
                                                                                                  InputDataComponent(
                                                                                                    label: 'Alamat',
                                                                                                    hintText: doctor.alamat,
                                                                                                    controller: TextEditingController(),
                                                                                                    readOnly: true,
                                                                                                  ),
                                                                                                  InputDataComponent(
                                                                                                    label: 'No Telpon',
                                                                                                    hintText: doctor.noTelp,
                                                                                                    controller: TextEditingController(),
                                                                                                    readOnly: true,
                                                                                                  ),
                                                                                                  Flexible(
              ...
              Obx(
                () {
                  return controller.numberOfPage.value == 0
                      ? Container()
                      : Container(
                          width: double.infinity,
                          padding: AppSizes.symmetricPadding(
                              ...
                              Container(
                                ...
                                child: NumberPaginator(
                                  ...
                                  onPageChange: (int index) {
                                    final page = index + 1;
                                    controller.getDoctor(page: page);
                                  },
