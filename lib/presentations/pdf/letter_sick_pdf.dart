...
class PdfLetterSick {
  ...
  static Widget buildIsi(DatumLetterSick datas) => Column(
        ...
        children: [
          ...
          Text('Nama              : ${datas.pasien.name}',
              style: TextStyle(fontSize: 10)),
          SizedBox(height: 10),
          Text('Jenis Kelamin : ${datas.pasien.jenisKelamin}',
              style: TextStyle(fontSize: 10)),
          SizedBox(height: 10),
          ...
          Text('Keluhan          : ${datas.complaint}',
              style: TextStyle(fontSize: 10)),
          SizedBox(height: 10),
          Text('Diagnosa        : ${datas.diagnosa}',
              style: TextStyle(fontSize: 10)),
          SizedBox(height: 10),
          Text(
              'Berdasarkan hasil pemeriksaan yang telah dilakukan, pasien tersebut dalam keadaan sakit, sehingga perlu beristirahat selama ${datas.restPeriod} hari, dari tanggal ${datas.startDate.toDateddmmmyyyyFormattedString()} s/d ${datas.endDate.toDateddmmmyyyyFormattedString()}.',
              style: TextStyle(fontSize: 10)),
          SizedBox(height: 10),
          Text(
  ...
  static Widget buildFooter(DatumLetterSick datas) =>
        ...
        Column(
          ...
          children: [
            ...
            Text('.........................................',
                style: TextStyle(fontSize: 10)),
            SizedBox(height: 10),
            Text('${datas.noLatter}', style: TextStyle(fontSize: 10)),
          ],
        )
      ]);
